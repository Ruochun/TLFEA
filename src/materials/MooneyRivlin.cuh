...
__device__ __forceinline__ void mr_invT3x3(const double A[3][3], double detA, double invT_out[3][3]) {
...
__device__ __forceinline__ void mr_compute_P(const double F[3][3],
                                             double mu10,
                                             double mu01,
                                             double kappa,
                                             double P_out[3][3]) {
...
__device__ __forceinline__ void mr_compute_tangent_tensor(const double F[3][3],
                                                          double mu10,
                                                          double mu01,
                                                          double kappa,
                                                          double A[3][3][3][3]) {
