...
ancf3443_b_vec_xi(Real xi, Real eta, Real zeta, Real L, Real W, Real H, Real* out) {
    Real u = L * xi / 2.0;
    Real v = W * eta / 2.0;
    Real w = H * zeta / 2.0;
...
__device__ __forceinline__ void
ancf3443_db_dxi(Real xi, Real eta, Real zeta, Real L, Real W, Real H, Real* out) {
...
__device__ __forceinline__ void
ancf3443_db_deta(Real xi, Real eta, Real zeta, Real L, Real W, Real H, Real* out) {
    Real u = 0.5 * L * xi;
    Real v = 0.5 * W * eta;
    Real w = 0.5 * H * zeta;
...
__device__ __forceinline__ void
ancf3443_db_dzeta(Real xi, Real eta, Real zeta, Real L, Real W, Real H, Real* out) {
    Real u = 0.5 * L * xi;
    Real v = 0.5 * W * eta;
